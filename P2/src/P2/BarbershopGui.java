...
//	private static final String IMAGE_PATH = "C:\\Users\\magnu\\Dropbox\\Intellij\\tdt4186-assignments\\src\\images\\";
	private static final String IMAGE_PATH = "src/p2/images/";
	...
	private void loadImages() {
		...
		wallsImage = loadImage(tk, IMAGE_PATH + "walls.gif", tracker);
		System.out.println("loaded walls");
		floorImage = loadImage(tk, IMAGE_PATH + "floor.gif", tracker);
		loungeChairImage = loadImage(tk, IMAGE_PATH + "loungechair.gif", tracker);
		barberChairImage = loadImage(tk, IMAGE_PATH + "barberchair.gif", tracker);
		barberImage = loadImage(tk, IMAGE_PATH + "barber.gif", tracker);
		customerImages = new Image[NOF_CUSTOMER_LOOKS];
		for(int i = 0; i < NOF_CUSTOMER_LOOKS; i++) {
			customerImages[i] = loadImage(tk, IMAGE_PATH + "customer"+i+".gif", tracker);
		}
		tableImage = loadImage(tk, IMAGE_PATH + "table.gif", tracker);
		deskImage = loadImage(tk, IMAGE_PATH + "desk.gif", tracker);
		sleepImage = loadImage(tk, IMAGE_PATH + "sleep.gif", tracker);
		try {
			tracker.waitForID(0);
