...
public class Statistics
{
	...
	public void printReport(long simulationLength) {
        ...
        System.out.println("Number of processed I/O operations:                                     "+nofProcessIO);
        System.out.println("Average throughput (processes per second):                              "+(float)nofCompletedProcesses/simulationLength*1000);


        System.out.println();
        System.out.println("Total CPU-time spent processing data:                                   "+timeSpentCPU + "ms");
        System.out.println("Fraction of CPU time spent processing data:                             "+(float)timeSpentCPU/simulationLength*100 + "%");
        System.out.println("Total CPU time spent waiting for something:                             "+(simulationLength-timeSpentCPU)+ "ms");
